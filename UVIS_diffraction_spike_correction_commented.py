...
1. Section 1, Lines 58-59: Set path to where fits files are kept and where you would like new ones saved - see note at beginning of Section 1 for details on how to structure directories
2. Section 1, Line 77: Set "kind" to whatever fits file type you are using (ima, flt, etc.)
3. Section 2, Lines 83-84: Enter size of x-axis and y-axis
4. Section 3, Lines 104-105: Set appropriate estimates for slope (m) and y-intercept (b) of line used to model spike. 
5. Section 3, Lines 124-130: Uncomment plot to plot image with estimated line - manually iterate this until line overlaps with center of spike. 
...
6. Section 3, Lines 135: You will need to input med_range, the interval length (in the spatial direction) over which you want to calculate median. 
7. Section 3, Lines 142-143: You can also adjust x_range (the horizontal range around which you will search for spike's shape) and lim (the half width of the spike shape)
8. Section 4, Lines 284-310: Uncomment last two plots to see how well your subtraction worked and the corrected compared with original image 
9. Copy and paste Sections 3-4 if you need to do this for multiple erroneous diffraction spikes (if you have a triplet system like LTT 1445Ab!)
...
data_path='/Users/katiebennett/Documents/LTT1445Ab/UVIS_Zafar/10_11_23/10_11_23_flt_files/HST' #path to data
save_path='/Users/katiebennett/Documents/LTT1445Ab/UVIS_Zafar/10_11_23_diff_corr/HST_flt_files/' #path to save corrected data to
...
#------Section 3: Model diffraction spike---------------------
    ...
    med_range=5 #Can change over what pixel range you want flux to be calculated
    ...
    '''
    If you are looking at a triplet system and need to subtract a second diffraction spike, copy and paste Sections 
    3 and 4 and repeat. You should only need to change the b (y-intercept) - everything else should stay the same.
    '''
